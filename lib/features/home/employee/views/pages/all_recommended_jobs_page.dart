...
class AllRecommendedJobsPage extends StatelessWidget {
  final List<JobListing> jobs;

  const AllRecommendedJobsPage({super.key, required this.jobs});
                        ...
                        child: Center(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                '${jobs.length} job${jobs.length != 1 ? 's' : ''} for you',
                                style: TextStyle(
                                  fontSize: 16,
      ...
      child: Center(
        child: Column(
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              'We\'re working on finding the perfect jobs for you. Check back later!',
